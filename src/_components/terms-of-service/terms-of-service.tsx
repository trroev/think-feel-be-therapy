      ...
      <DialogContent className="max-h-[calc(100vh-2rem)] overflow-scroll lg:max-w-[800px]">
        ...
        <div className="flex flex-col space-y-2">
          <p>
            ...
            carefully before using the www.rachaelmathiak.com website (the &quot;Website&quot;)
            operated by Rachael Mathiak Therapy LLC, a(n) Sole Proprietorship formed in Michigan,
            United States (&quot;us&quot;, &quot;we&quot;, &quot;our&quot;) as this Terms of Service
        ...
        <div className="flex flex-col space-y-2">
          ...
          <ul>
            <li>
              Impersonating or attempting to impersonate Rachael Mathiak Therapy LLC or its
            ...
            <li>
              Sending or attempting to send any advertising or promotional material, including but
            ...
            <li>
              ...
              of the Website, or which, as determined in our sole discretion, may harm us or the
              users of this Website or expose us or other users to liability
            </li>
            <li>
              Using the Website in any manner that could disable, overburden, damage or impair the
              Website or interfere with another party&apos;s use of the Website
            </li>
            <li>
              Using any robot, spider or other similar automatic technology, process or means to
              access or use the Website for any purpose, including monitoring or copying any of the
            ...
            <li>
              Using any device, software, means or routine that interferes with the proper working
              of the Website, including but not limited to viruses, trojan horses, worms, logic
              bombs or other such materials
            </li>
            <li>
              Attempting to gain unauthorized access to, interfering with, damaging or disrupting
              any parts of the Website, the server(s) on which the Website is stored, or any server,
              computer or database connected to the Website
            </li>
            <li>
              Attempting to attack or attacking the Website via a denial-of-service attack or a
              distributed denial-of-service attack
            </li>
            <li>Otherwise attempting to interfere with the proper working of the Website</li>
            <li>
              Using the Website in any way that violates any applicable federal, state or local
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Divider />
          <p className="uppercase">
            IN NO EVENT SHALL RACHAEL MATHIAK THERAPY LLC BE LIABLE FOR ANY DIRECT, INDIRECT,
            PUNITIVE, INCIDENTAL, SPECIAL OR CONSEQUENTIAL DAMAGES ARISING OUT OF, RELATING TO OR IN
            ANY WAY CONNECTED WITH YOUR ACCESS TO, DISPLAY OF OR USE OF THIS WEBSITE OR WITH THE
            DELAY OR INABILITY TO ACCESS, DISPLAY OR USE THIS WEBSITE, INCLUDING BUT NOT LIMITED TO
            YOUR RELIANCE UPON OPINIONS OR INFORMATION APPEARING ON THIS WEBSITE; ANY COMPUTER
            VIRUSES, INFORMATION, SOFTWARE, LINKED WEBSITES OPERATED BY THIRD PARTIES, PRODUCTS OR
            SERVICES OBTAINED THROUGH THIS WEBSITE, WHETHER BASED ON A THEORY OF NEGLIGENCE,
            CONTRACT, TORT, STRICT LIABILITY, CONSUMER PROTECTION STATUTES OR OTHERWISE, EVEN IF
            RACHAEL MATHIAK THERAPY LLC HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
          </p>
        </div>
        <div className="flex flex-col space-y-2">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Divider />
          <p>
            All contents of this Website are ©2023 Rachael Mathiak Therapy LLC or third parties.
            All rights reserved. Unless specified otherwise, this Website and all content and other
            materials on this Website including but not limited to all logos, designs, text,
            graphics, pictures, information, data, software, sound files and arrangement thereof
            (collectively, &quot;Content&quot;) are the proprietary property of Rachael Mathiak
            Therapy LLC and are either registered trademarks, trademarks or otherwise protected
            intellectual property of Rachael Mathiak Therapy LLC or third parties in the United
            States and/or other countries.
          </p>
          <p>
            If you are aware of a potential infringement of our intellectual property, please
            contact Rachael Mathiak at therapy@rachaelmathiak.com.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              A description of the work that you claim has been infringed, including the URL (i.e.,
              web page address) of the location where the work exists or a copy of the work
            </li>
          ...
          <p>
            ...
            costs and attorneys&apos; fees for any misrepresentation or bad faith claims regarding
            the infringement of your intellectual property rights by the Content on this Website.
          </p>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Divider />
          <p>We subscribe to the NASW, which can be found at the following link:</p>
          <a
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p>
            ...
            Michigan, United States, without regard to its conflict of laws provisions. THESE TERMS
          ...
          <p>
            ...
            competent jurisdiction in Kent County, Michigan.
          </p>
          <p>
            YOU AND RACHAEL MATHIAK THERAPY LLC AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p>
            ...
            provide you with any notice when we make changes to this Terms of Service.
          </p>
        </div>
        <div className="flex flex-col space-y-2">
          <h6>Questions</h6>
