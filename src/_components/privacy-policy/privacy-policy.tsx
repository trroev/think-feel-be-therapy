      ...
      <DialogContent className="max-h-[calc(100vh-2rem)] overflow-scroll lg:max-w-[800px]">
        ...
        <div className="flex flex-col space-y-2">
          <p>
            ...
            using the www.rachaelmathiak.com Website (the &quot;Website&quot;) operated by Rachael
            Mathiak Therapy LLC, a(n) Sole Proprietorship formed in Michigan, United States
            (&quot;us,&quot; &quot;we&quot;, &quot;our&quot;) as this Privacy Policy contains
            important information regarding your privacy and how we may use the information we
            collect about you.
          </p>
          <p>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p>
            ...
            browser. Cookies are generally used to allow websites to respond to you as an
            individual, to remember your preferences, to test content, and to analyze your
            interactions with Websites or with advertisements. This Website does not collect
            cookies.
          </p>
        </div>
        <div className="flex flex-col space-y-2">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p>
            ...
            not want to be tracked. We do not support Do Not Track (&quot;DNT&quot;). You can either
