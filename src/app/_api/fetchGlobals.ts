import type { Footer, Header, Navigation, Settings } from '../../payload/payload-types'
import { FOOTER_QUERY, HEADER_QUERY, NAVIGATION_QUERY, SETTINGS_QUERY } from '../_graphql/globals'
...
export const fetchGlobals = async (): Promise<{
  ...
  const [settings, header, footer, navigation]: [Settings, Header, Footer, Navigation] =
    await Promise.all([
      await settingsData,
      await headerData,
      await footerData,
